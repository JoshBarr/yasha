...
var halloPlugins = {
    ...
    'hallocleanhtml': {
        format: false,
        allowedTags: ['h2', 'h3', 'h4', 'h5', 'p', 'em', 'strong', 'br', 'div', 'ol', 'ul', 'li', 'a', 'figure', 'embed', 'blockquote', 'cite', 'img'],
